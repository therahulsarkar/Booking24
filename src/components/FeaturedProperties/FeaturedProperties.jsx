    ...
    <div className="fp">
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        /><div className="fpItemContainer">
        <span className="fpName">ITC Maurya</span>
        <span className="fpCity">Delhi</span>
        <span className="fpPrice">Starting from ₹14,000</span>
        <div className="fpRating">
          <button>9.0</button>
      ...
      <div className="fpItem">
        ...
        <span className="fpPrice">Starting from ₹10,500</span>
        <div className="fpRating">
          <button>9.1</button>
          <span>Excellent</span>
        </div>
